...
* [`src/stich/`](src/stich/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/stich/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `stich` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/stich/config.cljs) defaults to `true` in
...
```clj
(ns stich.example
  (:require [stich.config :as config])
